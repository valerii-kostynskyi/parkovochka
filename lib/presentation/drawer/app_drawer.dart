      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text('Change Theme', style: TextStyle(fontSize: 16)),
          ...
          ListTile(
            ...
            onTap: () {
              localeBloc.add(ChangeLocaleEvent(ApplicationLocale('en', 'US')));
              Navigator.pop(context); // Close the drawer
            },
          ),
          ListTile(
            leading: Icon(Icons.language, color: Colors.blue),
            title: Text('Українська', style: TextStyle(fontSize: 16)),
            onTap: () {
              localeBloc.add(ChangeLocaleEvent(ApplicationLocale('uk', 'UA')));
              Navigator.pop(context); // Close the drawer
            },
          ),
        ],
